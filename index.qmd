...
these challenges by introducing the Quarto scientific and technical publishing system for
...
During the, participants will learn how to use the Quarto file
format to prepare scholarly documents, including slides, and scientific reports. 
...
1.  A browser that is one of Mozilla Firefox,
    Safari, Google Chrome, Arc, Microsoft Edge (just not the Internet
    Explorer)
    
2.  Access to a laptop or desktop computer  (you won't be able to do this on a phone or tablet)

3.  A free account on https://posit.cloud/ (or login with GitHub)
